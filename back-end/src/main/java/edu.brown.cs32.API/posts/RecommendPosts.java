...
public class RecommendPosts {
  ...
  public static List<List<Object>> defaultPostSorter(List<List<Object>> postsDB) {
    ...
    System.out.println("defaultPostSorter entered!!!!");
    ...
    for (List<Object> pPair : postsDB) {
      ...
      if (p.endDate == null) {
        ...
        System.out.println("future post list: " + futurePosts);
      } else {
        System.out.println("should be true: " + p.endDate.before(now));
        if (p.endDate.before(now)) {
          pastPosts.add(pPair);
          System.out.println("past post list: " + pastPosts);
        } else {
          futurePosts.add(pPair);
          System.out.println("future post list: " + futurePosts);
        }
  ...
  public List<List<Object>> generatePostRecs(Post post, Integer numRecs) throws Exception {
    ...
    // mock DB!!!
//    Firebase.setUser(new User("joe", "joe"));
//    Post xmasPost =
//        new PlanePost(
//            "joe",
//            "xmas post",
//            null,
//            "LAX",
//            new Date(2022 - 1900, Calendar.DECEMBER, 20),
//            new Date(2023 - 1900, Calendar.DECEMBER, 26), //should overlap with molly_mchenry xmas post
//            null,
//            null);
//    Post halloweenPost =
//        new CarPost(
...
//            null,
//            "NYC",
//            new Date(2000 - 1900, Calendar.OCTOBER, 31),
//            null);
//    Post marchPost =
//        new PlanePost(
//            "joe",
...
//            null,
//            "PBI",
//            new Date(2000 - 1900, Calendar.MARCH, 1),
//            null,
//            null,
//            null);
//    Post midJunePost =
...
//            null,
//            "GSP",
//            new Date(2000 - 1900, Calendar.JUNE, 15),
//            null,
//            null,
//            null);
//
//    ArrayList<List<Object>> postsDB_3 = new ArrayList<>();
//    List<Object> recPostPairs_midJune = new ArrayList<>();
//    recPostPairs_midJune.add(midJunePost.userID);
//    recPostPairs_midJune.add(midJunePost);
//    postsDB_3.add(recPostPairs_midJune);
//
//    List<Object> recPostPairs_xmas = new ArrayList<>();
//    recPostPairs_xmas.add(xmasPost.userID);
//    recPostPairs_xmas.add(xmasPost);
//    postsDB_3.add(recPostPairs_xmas);
//
//    List<Object> recPostPairs_halloween = new ArrayList<>();
//    recPostPairs_halloween.add(halloweenPost.userID);
//    recPostPairs_halloween.add(halloweenPost);
//    postsDB_3.add(recPostPairs_halloween);
//
//    List<Object> recPostPairs_march = new ArrayList<>();
//    recPostPairs_march.add(marchPost.userID);
//    recPostPairs_march.add(marchPost);
//    postsDB_3.add(recPostPairs_march);

    //TODO get friends' posts needs to return a 2d array of smaller lists: [friendID, PostObject]
