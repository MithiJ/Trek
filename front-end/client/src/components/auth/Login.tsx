...
export default function Login (){
    ...
    const [profile, setProfile] = useState(null);
      ...
      return (
          <div className="navbar-container-bigger">
             {profile ? (
                        <div className="navbar-container">
                              <ul >
                                    ...
                                    <div className="links">
                                     ...
                                     {/* <Link to="/alternativecreate" aria-label="Alternative Create">Alternative Create </Link> */}
                    ...
                    <GoogleLogin   
                        ...
                        isSignedIn={true}
                        style={{ width:50, height:50, margin: 40 , paddingLeft: 200}} 
                    />
