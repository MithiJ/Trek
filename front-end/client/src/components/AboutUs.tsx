...
const AboutUs = () => {
  return (
    <div className="aboutUs" aria-label="About Us">
      <h2 style={{color:"navy", fontSize:30, padding:20, textAlign:"center"}}> About Us</h2>
      <h4 style={{color:"navy", fontSize:20,  textAlign:"center", paddingBottom:5}}> <strong>Great Travel with Even Greater Company!</strong></h4>
      <p style={{paddingBottom:30}}>
        Trek is a social media app focused on making your traveling planning easier so that you're always in great company! You can use Trek as a tool to ...
        <li>
          Add your friends (predetermined by the backend of course!) to view their upcoming travel plans
        </li> 
        <li>
            Create a post of your own detailing where you're headed next
        </li>
        <li>
          Track your own posts, as well as the posts recommended to you!
        </li>
      </p>
      <h4 style={{color:"navy", fontSize:20,  textAlign:"center", paddingBottom:10}}> The Team</h4>
      ...
      <h4 style={{color:"navy", fontSize:20,  textAlign:"center", paddingBottom:10, paddingTop:10}}> Privacy Policy</h4>
